...
<head>
    ...
    <title>Cadastro de Culturas</title>
    <script type="text/javascript">	
		<?php
           ...
           $segmentoCultura = array();
			...
			if (isset($_POST['search'])) {
				//Se existe...
				$segmentoCultura = $segmentoCulturaDAO->searchSegmentoCulturaVarredura($_POST['search']);
			} else {
				//Se não existe...
				$segmentoCultura = $segmentoCulturaDAO->searchSegmentoCultura();                        
			}
			
            echo "var segmentoCulturas = ".json_encode($segmentoCultura).";";
            
            //Imprime os segmentoCulturas no console
            //echo "console.log(segmentoCulturas);";
		?>
		
		// Método para abrir o modal de acordo com o botão clicado
		function abreModalDeEdicao(indice) {
			
			// Pegando o segmentoCultura pelo indice do botão
			let segmentoCultura = segmentoCulturas[indice];
			
            // Agora é só setar o nome do segmentoCultura nas variaveis do modal e depois abrir o modal
            document.getElementById("id-edit").value = segmentoCultura.id;
			document.getElementById("descricao-edit").value = segmentoCultura.descricao;
        ...
        /*
         * Função JS que solicita confirmação da exclusão de um SegmentoCultura
         */
        function confirmaExclusao(id) {
            var resposta = confirm("Deseja remover esse registro?");        
            if (resposta == true) {
                window.location.href = "../../controller/controller_segmentoCultura.php?operation=excluir&id="+id;
            }
        }
    </script>
</head>
<body>
    <header>
        <div class="barra_horizontal">
            <img id="logo_pagina" src="../../img/culturas.png" href="../../css/style.css">
            <p align="left" id="nome_pagina">Culturas/Segmentos</p>
            <p align="left" id="descricao_nome_pagina">Cadastro de Culturas/Segmentos de Negócio</p>       
        </div>
                ...
                <ul id="nav">
                    ...
                    <li><span id="span_register"></span><a href="../cadastros.php" class="menu_enable">Cadastro -</a>
                        <ul>
                            ...
                            <li><a href="cad_segmentos_culturas.php" class="sub_menu_enable" id="active">- Segmento/Culturas</a></li>
    ...
    <!--
        Tabela que exibe os Segmento/Culturas
    -->
        ...
        <table class="tabela_cadastros">
            ...
            <thead>
                <tr>
                    ...
                    <th class="th_cadastros">Segmento/Culturas</th>
                    <th class="th_crud" colspan="2">Alterar</th>
                </tr>
            </thead>

            <!--
                Exibe na tabela todos os Segmento/Culturas cadastrados ou correspondentes a pesquisa 
            -->
            <tbody>
                <div id="search-div">
                    <?php 
    ...
    <!--
        Janela Modal para INSERIR Segmento/Culturas
    -->
    <div id="modal-window-insert" class="modal-window" >
        <div class="modal-box-1">
            <form action="../../controller/controller_segmentoCultura.php?operation=cadastrar" class="user-crud-box-1" name="register_form" id="register_form" method="POST">
    ...
    <!--
        Janela Modal para EDITAR Segmento/Culturas
    -->
    <div id="modal-window-update" class="modal-window" >
        <div class="modal-box-1">
            <form action="../../controller/controller_segmentoCultura.php?operation=alterar" class="user-crud-box-1" name="register_form" id="register_form" method="POST">
                <div>
