...
<body style="background-color: #848484">
    ...
    <form class="div_view_erros">
        ...
        <p id="title_error" align="center" >ERRO NA ALTERAÇÂO DO USUÁRIO</p><br/>
        ...
        <br/>
        <p align="center">Para voltar à área de cadastro,<a href="def_altera_dados_usuario_logado.php"> clique aqui.</a></p>
    </form>
    <div id="rodape">
