...
<body style="background-color: #848484">
            ...
            <nav>
                <ul id="nav">
                    ...
                    <li><span id="span_dashboard"></span><a href="dashboard.php" class="menu_enable">Dashboard -</a>
                        <ul>
                            <li><a href="dashboard/painel.php" class="sub_menu_enable">- Painel</a></li>
                            <li><a href="dashboard/graficos.php" class="sub_menu_enable">- Gráficos</a></li>
                        </ul>
                    </li>
    ...
    <img id="logo_principal_menu" src="../img/dashboard_cat.png" href="../css/style.css">
    <div id="rodape">
