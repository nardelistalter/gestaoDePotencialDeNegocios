...
<body style="background-color: #848484">
    ...
    <form class="div_view_erros">
        ...
        <p id="title_error" align="center" >ERRO NO CADASTRO DE PROGRAMAS DE NEGÓCIOS</p><br/>
        ...
        <br/>
        <p align="center">Para voltar à área de cadastro,<a href="cad_programas_negocios.php"> clique aqui.</a></p>
    </form>
    <div id="rodape">
