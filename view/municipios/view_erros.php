...
<body style="background-color: #848484">
    ...
    <form class="div_view_erros">
        ...
        <p id="title_error" align="center" >ERRO NO CADASTRO DE MUNICÍPIOS</p><br/>
        ...
        <br/>
        <p align="center">Para voltar à área de cadastro,<a href="cad_municipios.php"> clique aqui.</a></p>
    </form>
    <div id="rodape">
